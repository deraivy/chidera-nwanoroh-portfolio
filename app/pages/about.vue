      ...
      <div class="w-full md:container mx-auto px-5">
        ...
        <section class="flex flex-col lg:flex-row items-center gap-8 lg:gap-24">
          ...
          <div class="text-center lg:text-left">
            <p
              class="text-sm font-semibold mb-4 text-[#ff6b37] uppercase tracking-widest"
            >
              Who am I?
            </p>
            <h3
              class="text-3xl sm:text-4xl lg:text-5xl text-white font-bold mb-6"
            >
              I’m Nwanoroh Chidera, a Frontend Developer
            </h3>
            <p
              class="text-base sm:text-lg text-gray-300 leading-relaxed mb-6 max-w-2xl"
            >
              I’m a frontend developer who enjoys turning complex problems into
              <span class="font-semibold text-[#ff6b37]/80"
                >simple, elegant solutions</span
              >. My focus is on building
              <span class="font-semibold text-[#ff6b37]/80">responsive</span>,
              <span class="font-semibold text-[#ff6b37]/80">accessible</span>,
              and
              <span class="font-semibold text-[#ff6b37]/80">SEO-friendly</span>
              websites that perform seamlessly across all devices.
            </p>
            <p
              class="text-base sm:text-lg text-gray-300 leading-relaxed max-w-2xl"
            >
              I specialize in
        ...
        <section class="py-16">
          ...
          <p
            class="text-base sm:text-lg text-gray-300 text-center max-w-3xl mx-auto mb-12"
          >
            From tackling challenges with enthusiasm to creating lasting
          ...
          <div class="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div
                class="space-y-6 relative border-l-2 rounded-xl border-[#ff6b37]"
              >
                <div
                  class="relative bg-[#14151a] backdrop-blur-sm p-6 rounded-xl shadow-lg"
                >
                  <p class="text-sm font-semibold text-[#ff6b37]">
                    2018 - 2023
                  </p>
                  <p class="font-semibold text-xl text-white mt-2">
            ...
            <!-- Job Experience -->
            <div>
              <h4 class="text-2xl font-semibold text-white mb-6">
                Job Experience
              </h4>
              <div
                class="space-y-6 relative border-l-2 rounded-xl border-[#ff6b37]"
              >
                ...
                >
                  ...
                  <p class="text-sm text-gray-400">
                    Speedpay Finance Nigeria Limited
                  </p>
                  <p class="mt-3 text-gray-300 leading-relaxed">
                    Built and maintained high-performance web applications,
                    focusing on responsive design, SEO optimization, and modern
                    frontend workflows.
                  </p>
                </div>
              </div>
        ...
        <section class="py-16">
          ...
          >
            ...
            >
              <div
                class="bg-gray-800 p-4 rounded-full shadow-md group-hover:bg-gray-800 transition-all duration-300 w-16 h-16 flex items-center justify-center"
              >
                <img :src="skill.icon" :alt="skill.name" class="w-8 h-8" />
              </div>
              <span
                class="text-gray-300 text-sm mt-2 group-hover:text-[#ff6b37]/80 transition-colors duration-300"
                >{{ skill.name }}</span
              >
            </div>
          </div>
