...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-DC22wfda.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-R753BBZZ.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./projects-BOGGjsx8.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-DcIxWtpx.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-obYcY0-9.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DF8j501t.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-PSP7b2_w.mjs'));
...
export { _export_sfc as _, useRuntimeConfig as a, useRequestEvent as b, useRouter as c, nuxtLinkDefaults as d, entry$1 as default, useAppConfig as e, asyncDataDefaults as f, createError as g, navigateTo as n, resolveRouteObject as r, useNuxtApp as u };
